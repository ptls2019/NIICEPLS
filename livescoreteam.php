	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="knockkfoot.php" class="nav-link">Match Schedule</a></li>
	          <li class="nav-item active"><a href="livescoreteam.php" class="nav-link">All Result</a></li>
